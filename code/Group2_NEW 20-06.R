...
data$sirilabel = ifelse(abs(data$Bodyfat-data$BODYFAT)>sort(abs(data$Bodyfat-data$BODYFAT))[5],data$IDNO,"")
...
data$bmilabel = ifelse(abs(data$BMI-data$ADIPOSITY)>sort(abs(data$BMI-data$ADIPOSITY))[4],data$IDNO,"")
